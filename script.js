...
fetch('congressmen.json')
    ...
    .then(data => {
        ...
        const defaultEmailBody = `Dear Congressman,%0A%0A
        I hope this message finds you well. As a U.S. citizen of Pakistani origin, I am writing to express my concerns as a constituent. I deeply value the commitment of Congressmen towards protecting democracy and human rights around the globe. Your recent letter to President Biden, though well-intended, does not fully account for the realities and complexities on ground and inadvertently misrepresents certain aspects of the situation.%0A%0A
        ...
        function updateMailtoLink(selectedCongressman, selectedConstituency) {
            ...
            if (selectedCongressman || selectedConstituency) {
                ...
                if (congressmanData) {
                    ...
                    emailBody = `Dear ${congressmanData.name},%0A%0A
